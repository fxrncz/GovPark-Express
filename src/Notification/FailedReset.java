...
public class FailedReset extends JPanel {
	...
	public void paint(Graphics g) {
        ...
        check = new ImageIcon("img/Cancel.png").getImage();
	...
	public FailedReset() {
		...
		JLabel message1 = new JLabel("Failed to reset your password");
		message1.setBounds(68, 23, 280, 50);
