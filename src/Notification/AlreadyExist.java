...
public class AlreadyExist extends JPanel {
	...
	public AlreadyExist() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(holder, GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
		);
		...
		JLabel message = new JLabel("Your email is already exist.");
