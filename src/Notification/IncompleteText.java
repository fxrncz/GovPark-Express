...
public class IncompleteText extends JPanel {
	...
	public IncompleteText() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(holder, GroupLayout.DEFAULT_SIZE, 230, Short.MAX_VALUE)
		);
		...
		JLabel message = new JLabel("Fill all the textfields.");
