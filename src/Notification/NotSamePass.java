...
public class NotSamePass extends JPanel {
	...
	public NotSamePass() {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addComponent(holder, GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
		);
		...
		JLabel message = new JLabel("Your password do not match.");
